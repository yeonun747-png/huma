...
export function NarrationScriptView({ service }: Props) {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-3">
      <NarrationPersonaPanel key={service} service={service} />
          ...
          <label className="text-[11px] text-huma-t3">
            ...
            >
              ...
              <option value="monthly">
                {resolvePeriodLabel('monthly')} ({resolvePeriodHint('monthly')})
              </option>
            </select>
          </label>
          <label className="text-[11px] text-huma-t3">
                  ...
                  <li key={item.id}>
                    ...
                    >
                      ...
                      <div className="mt-0.5 flex flex-wrap gap-1 text-[9px] text-huma-t4">
                        <MTag tone="idle">
                          {resolveVariantLabel(item.format_type, item.period_type)}
                        </MTag>
