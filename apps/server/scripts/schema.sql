...
('human_engine', '{"wpm_mean":55,"wpm_sigma":18,"typo_rate":0.04,"backspace_delay_ms":[200,800],"paragraph_pause_ms":[2000,8000],"review_duration_ms":[120000,300000],"night_ban_start":1,"night_ban_end":7}'),
('image_engine', '{"noise_pct":0.8,"jpeg_quality_range":[90,96],"exif_randomize":true,"gps_randomize":true}'),
