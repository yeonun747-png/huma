...
export const POST_BLOG_RETRYABLE_ERRORS = [
  ...
  'BLOG_TITLE_SECTION_NOT_READY',
  'BLOG_BODY_NOT_FOUND',
  'BLOG_BODY_WRITE_FAILED',
  'BLOG_BODY_INSERTED_INTO_TITLE',
  'BLOG_TITLE_LOST_BEFORE_REVIEW',
  'DRAFT_RESUME_POPUP_STILL_VISIBLE',
  'BLOG_EDITABLE_NOT_INTERACTABLE',
  'BLOG_EDITABLE_BLOCKED_BY_OVERLAY',
  'BLOG_EDITABLE_INSERT_NOOP',
